...
<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{URL::to('/public/upload/products/'.$pro->Product_image)}}" alt="" />
								<h3>ZOOM</h3>
							</div>
							<div id="similar-product" class="carousel slide" data-ride="carousel">
								  ...
								  <!--   <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="{{URL::to('/public/upload/products/'.$pro->Product_image)}}" alt=""></a>
										  <a href=""><img src="{{URL::to('/public/upload/products/'.$pro->Product_image)}}" alt=""></a>
										  <a href=""><img src="{{URL::to('/public/upload/products/'.$pro->Product_image)}}" alt=""></a>
										</div>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#details" data-toggle="tab">Content</a></li>
								...
								<div class="item active">	
									...
									<div class="col-sm-4">
                                        ...
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to('public/upload/products/'.$value->Product_image)}}" width="200" height="200" alt="" />
